...
- **Global scope**: `/Users/njs50/play/Mudlet/.claude/notes/{YYYY-MM-DD}-{slug}.md` — fallback when no `.planning/`, or when `--global` flag is present
...
2. Ensure the notes directory exists (`.planning/notes/` or `/Users/njs50/play/Mudlet/.claude/notes/`)
...
2. Glob `/Users/njs50/play/Mudlet/.claude/notes/*.md` (if directory exists) — global notes
...
Global (/Users/njs50/play/Mudlet/.claude/notes/):
...
2. **No `.planning/`**: Falls back to global `/Users/njs50/play/Mudlet/.claude/notes/` — works in any directory
